...
// Función para dar formato a las series para las vistas de historial y último registro
    ...
    mainContent.innerHTML = `
        <div class="card">
            ...
            <div class="exercise-columns-container">
                ...
                <div class="exercise-column">
                    <div class="column-title">Último Registro</div> ${previousData ?
            ...
            : '<p>No hay registros anteriores.</p>'}
                ...
                <div class="exercise-column">
                     <div class="column-title">Hoy</div> <div id="sets-container" class="today-sets-container">
                        </div>
                </div>
            </div>
...
function addSetToUI(reps, weight) {
    ...
    // The Set #: Reps x Weight kg format remains for live tracking,
